                                   ...
                                   <?php
											...
											if(!isset($message)){
												...
												echo'
													<div class="alert alert-success">
														...
														<strong>Success!</strong> Success Adding '.$roomName.' branch.
													</div>
													...
													echo'
														<div class="alert alert-danger">
															<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
															<strong>Error!</strong> Error '.$roomName.' branch.
														</div>
									...
									?>
                                        ...
                                        <div class="form-group">
                                            <input name="roomName" class="form-control" placeholder="Edit Room Name">
                                        </div>
										<div class="form-group">
                                            <input name="roomDescription" class="form-control" placeholder="Edit Room Description">
                                        </div>
										<div class="form-group">
                                            <label>Branch <label>
